      ...
      <div className=" relative verses rounded-md w-full min-h-screen flex flex-col items-center justify-center mt-5">
        <div className="absolute -top-7 right-1 flex space-x-3">
          <Image
            ...
            width={100}
            height={100}
            className="rounded-full h-12 w-12 md:h-20 md:w-20  aspect-square object-cover ring-4 ring-purple-900 animate-pulse"
          />
          <Image
            src={"/quran1.jpg"}
            width={100}
        ...
        <div className="flex flex-col items-center justify-start pt-32 md:pt-2 md:justify-center min-h-screen w-full bg-opacity-50 rounded-md p-2 overflow-y-auto">
          <Verse />
